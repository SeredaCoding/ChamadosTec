          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <?php
                  if(isset($_GET['abertura_chamado']) && $_GET['abertura_chamado'] == 'sucesso'){              
                ?>
                ...
                <?php }else if(isset($_GET['abertura_chamado']) && $_GET['abertura_chamado'] == 'erro'){ ?>

                <script>
                  alert('Ocorreu um erro ao abrir o chamado!');
                </script>
                <div class="col-12 text-danger">
                  <h4>Ocorreu um erro ao abrir o chamado!</h4>
                </div>
